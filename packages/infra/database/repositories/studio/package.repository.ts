...
import type { Package, PackageId, IPackageRepository } from "@odin/domain";
import {  } from "@odin/domain";
import { mapDatabaseError } from "../../error-mapper";
import { DbTimestamp, JsonColumn, Pagination } from "../../types";

export class SqlitePackageRepository implements IPackageRepository {
  constructor(private db: Database) {}

  async findById(id: PackageId): AsyncResult<Package | null> {
    try {
      // TODO: Implement
  ...
  async save(entity: Package): AsyncResult<void> {
    try {
      // TODO: Implement
  ...
  async delete(id: PackageId): AsyncResult<void> {
    try {
      // TODO: Implement
      return { success: true, data: undefined };
    } catch (error) {
